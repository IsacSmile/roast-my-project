...
import { FolderGit2, Upload, Flame, FolderArchive, ArrowRight, CheckCircle, AlertCircle } from 'lucide-react';
import type { AnalyzeParams, SamplePreset } from '../types';
                ...
                {selectedFile ? (
                  <>
                    ...
                    <div className="text-xs text-zinc-500">
                      Size: {selectedFile.size} • Ready for simulated analysis
                    </div>
                  </>
                ) : (
                  <>
